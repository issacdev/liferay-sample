...
public class EditSampleListener implements IInit, ClickListener {
	...
	public void buttonClick(ClickEvent event) {
		...
		IEnquiryView infoView = (IEnquiryView) view.getView("EditSampleView");

		infoView.resetPage();

		Map<String, Object> row = (Map<String, Object>) event.getButton().getData();
		row.put(SampleConstant.ORG_VALUE, row.get(SampleConstant.VALUE));

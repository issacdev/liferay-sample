...
public class DeleteSampleListener implements IInit, ClickListener {
	...
	public void buttonClick(ClickEvent event) {
		...
		IEnquiryView infoView = (IEnquiryView) view.getView("DeleteSampleView");
